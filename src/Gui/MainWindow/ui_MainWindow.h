...
public:
    ...
    QAction *m_aboutauruxcoinAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/auruxcoin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutauruxcoinAction = new QAction(MainWindow);
        m_aboutauruxcoinAction->setObjectName(QStringLiteral("m_aboutauruxcoinAction"));
        m_aboutauruxcoinAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutauruxcoinAction);
        ...
        QObject::connect(m_aboutauruxcoinAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
...
#endif // QT_NO_TOOLTIP
        m_aboutauruxcoinAction->setText(QApplication::translate("MainWindow", "About auruxcoin", 0));
